...
import { Modal, Button, Input, List, Icon } from "antd";
import '../style.css';
                ...
                <div>
                  ...
                  >
                    <Input
                      ...
                      defaultValue={input}
                    />
                    <Button style={{ float: 'left' }} htmlType="submit" >Update</Button>
                    <Button style={{ float: 'right' }} type="button" onClick={() => updateCssEdit(item.id)}>Cancel</Button>
                  </form>
                </div>
              );
